...
void SharedMemory::dump_to_binary_file(const std::string& output_filename) const {
...
void SharedMemory::dump_to_text_file(const std::string& output_filename) const {
